...
import ResourceMesh, { RESOURCE_TYPE_STYLES } from './ResourceMesh';
...
const ResourceExplorer = ({ documentId, documentTitle }) => {
    ...
    const selectedResourceStyle = selectedNode?.type === 'resource'
        ? RESOURCE_TYPE_STYLES[selectedNode.resourceType]
        : null;
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-start">
                ...
                <div className="bg-bg-card border border-border-light rounded-xl p-4 min-h-[200px]">
                    {!selectedNode ? (
                        <p className="text-sm text-text-muted leading-relaxed">
                        ...
                        <div className="flex flex-col gap-3">
                            {selectedResourceStyle && (
                                <span className={`self-start text-[10px] font-semibold uppercase tracking-wide px-2 py-0.5 rounded-full ${selectedResourceStyle.badgeClass}`}>
